...
branded domain (e.g. alphaforbaby.alpha-tech.live → Shopify).
...
async def ensure_dns_cname(name: str, target: str = SHOPIFY_CNAME_TARGET, proxied: bool = False) -> dict:
    ...
    `name` is the full hostname (e.g. "alphaforbaby.alpha-tech.live"). Returns
...
async def point_subdomain_to_shopify(subdomain: str, root: str = "alpha-tech.live") -> dict:
    ...
    point_subdomain_to_shopify("alphaforbaby") → alphaforbaby.alpha-tech.live."""
