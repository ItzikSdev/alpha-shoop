...
#   - theme.config.json  (copied from timeforbaby — edit brand/colors/hero/products)
...
SRC="$APP_DIR/store-profiles/timeforbaby"
...
[ -d "$SRC" ] || die "template profile store-profiles/timeforbaby missing"
