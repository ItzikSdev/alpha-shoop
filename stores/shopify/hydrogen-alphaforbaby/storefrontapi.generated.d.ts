...
export type CartLinesForMergeQueryVariables = StorefrontAPI.Exact<{
  cartId: StorefrontAPI.Scalars['ID']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CartLinesForMergeQuery = {
  cart?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Cart, 'id'> & {
      lines: {
        nodes: Array<
          | (Pick<StorefrontAPI.CartLine, 'quantity'> & {
              merchandise: Pick<StorefrontAPI.ProductVariant, 'id'>;
            })
          | (Pick<StorefrontAPI.ComponentizableCartLine, 'quantity'> & {
              merchandise: Pick<StorefrontAPI.ProductVariant, 'id'>;
            })
        >;
      };
...
export type CartRecProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type FbtProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type ProductsByCollectionForFbtQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
...
export type ProductsByCollectionForFbtQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
...
> & {
  ...
  sizeGuide?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
interface GeneratedQueryTypes {
  '#graphql\n  query CartLinesForMerge($cartId: ID!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    cart(id: $cartId) {\n      id\n      lines(first: 250) {\n        nodes {\n          quantity\n          merchandise {\n            ... on ProductVariant {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CartLinesForMergeQuery;
    variables: CartLinesForMergeQueryVariables;
  };
  ...
  '#graphql\n  query ProductsByCollectionForFBT($handle: String!, $first: Int!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      products(first: $first) {\n        nodes {\n          id\n          handle\n          title\n          featuredImage { url altText width height }\n          variants(first: 50) {\n            nodes {\n              id\n              availableForSale\n              price { amount currencyCode }\n              selectedOptions { name value }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProductsByCollectionForFBTQuery;
    variables: ProductsByCollectionForFBTQueryVariables;
  };
