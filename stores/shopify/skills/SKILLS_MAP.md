...
| **Build / deploy / release (CI/CD)** | `hydrogen-timeforbaby/docs/CI_CD.md` |
...
4. Deploy per `docs/CI_CD.md` (`./scripts/deploy.sh timeforbaby`), verify the live domain, report to Slack.
